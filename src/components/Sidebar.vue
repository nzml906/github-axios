    ...
    <div class="sidebar__content">
      <div class="sidebar__head">
        <img
          ...
          alt="Vue Github Explorer Logo White"
        />
      </div>
      <ul class="sidebar__menu">
        ...
        <li class="sidebar__item">
          <router-link
            :to="'/' + userActionTab.login + '/profile/'"
            @click.native="navigateTo"
            v-if="userActionTab.hideHomeIcon"
            class="sidebar__link"
          >
        ...
        <li class="sidebar__item">
          <router-link
            :to="'/' + userActionTab.login + '/repositories/'"
            @click.native="navigateTo"
            class="sidebar__link"
          >
        ...
        <li class="sidebar__item" v-if="!userActionTab.isOrg">
          <router-link
            :to="'/' + userActionTab.login + '/followers/'"
            @click.native="navigateTo"
            class="sidebar__link"
          >
        ...
        <li class="sidebar__item" v-if="!userActionTab.isOrg">
          <router-link
            :to="'/' + userActionTab.login + '/following/'"
            @click.native="navigateTo"
            class="sidebar__link"
          >
